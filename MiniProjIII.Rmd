...
```{r, message = FALSE, warning = FALSE, label = "Set Up", include = FALSE}
library(tidyverse)
library(dplyr)
library(sf)
library(etl)
...
```{r, message = FALSE, warning = FALSE, label = "Data Manipulating", include = FALSE}
...
```{r, message = FALSE, warning = FALSE, label = "Merge Into another Code", include = FALSE}
df <- df_trails %>%
...
this chunk below should totally be turned into a table!!!
```{r, results = 'asis', message = FALSE, warning = FALSE, label = "Difficulty Level"}
#the chunk below is an example of making a data frame in a table and I (sofia) will use it to figure out how to make a table in the future
...
```{r, message = FALSE, warning = FALSE, label = "Our Map Code"}
