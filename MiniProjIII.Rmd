...
library(macleish)
library(leaflet)
elcontour<- st_read("hp214.shp") # note for sofia. When you download make sure that the files from hp214 is in the same folder as your folder. We changed this so it should be done for you in the git file
```
